...
<table class="table table-bordered table-sm fv-table">
    ...
    <tfoot>
        <tr>
            <td>#</td>
            <td><input type="date" id="rl-fv-date" class="form-control form-control-sm"></td>
            <td><input type="text" id="rl-fv-officers" class="form-control form-control-sm" placeholder="Comma-separated names"></td>
            <td>
                <select id="rl-fv-status" class="form-control form-control-sm">
            ...
            <td>
                <button id="rl-fv-add-btn" class="btn btn-success btn-sm" disabled title="Fill required fields">
...
(function(){
    ...
    var dateEl = document.getElementById("rl-fv-date");
    var officersEl = document.getElementById("rl-fv-officers");
    var statusEl = document.getElementById("rl-fv-status");
    ...
    addBtn.addEventListener("click", function(){
        ...
        fetch("ajax_residential_lease/add_field_visit.php", {
            method:"POST",
    ...
    function bindCancelButtons(){
        document.querySelectorAll(".rl-fv-cancel-btn").forEach(btn => {
    ...
    function doCancel(id){
        ...
        fetch("ajax_residential_lease/cancel_field_visit.php", {
            method:"POST",
            headers:{"Content-Type":"application/x-www-form-urlencoded"},
            body:fd.toString()
        })
