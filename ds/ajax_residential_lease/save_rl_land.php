...
try {
    if ($land_id === null) {
        ...
        UserLog("2", "RL Add Land", "Land ID=$new_id | Ben ID=$ben_id  | Address=$land_address | Extent=$extent $extent_unit", $ben_id, 'RL');
        ...
        if ($change_text !== "") {
            UserLog("2", "RL Edit Land", "Land ID=$land_id | $change_text", $ben_id, 'RL');
        }
