      ...
      if ($stmt2 = mysqli_prepare($con, 'SELECT land_id, ben_id, land_address, extent, extent_unit, extent_ha FROM ltl_land_registration WHERE ben_id=? ORDER BY land_id DESC LIMIT 1')){
        ...
        if ($res2 && ($land = mysqli_fetch_assoc($res2))) {
          ...
          if ($existing_lease) {
                ...
                $first_lease_flag = isset($existing_lease['first_lease']) ? (int)$existing_lease['first_lease'] : 1;
                $last_lease_annual_value = isset($existing_lease['last_lease_annual_value']) ? $existing_lease['last_lease_annual_value'] : '';
    ...
    <div class="card-block">
        ...
        <form id="ltlCreateLeaseForm">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Letter Date (Valuvation )*</label>
              ...
              ?>" <?php echo $existing_lease ? 'readonly ' : ''; ?> />
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ltl_initial_rent" name='initial_annual_rent'
                            value="<?php echo htmlspecialchars($existing_lease['initial_annual_rent'] ?? ''); ?>"
            ...
            <div class="row align-items-center">
                <div class="col-md-4">
                    <input type="hidden" name="first_lease" id="ltl_first_lease"
                        value="<?php echo $first_lease_flag ? 1 : 0; ?>" />
